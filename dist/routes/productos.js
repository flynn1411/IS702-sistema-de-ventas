...
ProductoRouter.get("/list-by-category/:id", productos_1.obtenerProductosPorCategoria);
ProductoRouter.get("/list-by-manufacturer/:id", productos_1.obtenerProductosPorFabricante);
